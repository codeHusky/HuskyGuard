...
import com.codehusky.huskyguard.event.debug.*;
import com.codehusky.huskyguard.util.report.CancelReport;
...
public class SpongeDebugHandler implements DebugHandler {

    private static final Logger log = Logger.getLogger(SpongeDebugHandler.class.getCanonicalName());
