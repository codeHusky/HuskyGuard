...
import com.codehusky.huskyguard.chest.SpongeSignChestProtection;
import com.codehusky.huskyguard.internal.TargetMatcherSet;
 ...
 * @author Michael
 */
public class SpongeWorldConfiguration extends YamlWorldConfiguration {

    private static final TargetMatcherParser matcherParser = new TargetMatcherParser();

    @Unreported private String worldName;

    @Unreported private ChestProtection chestProtection = new SpongeSignChestProtection();
