...
import com.codehusky.huskyguard.event.DelegateEvent;
import com.codehusky.huskyguard.event.block.BreakBlockEvent;
import com.codehusky.huskyguard.event.block.PlaceBlockEvent;
import com.codehusky.huskyguard.event.block.UseBlockEvent;
import com.codehusky.huskyguard.event.entity.DamageEntityEvent;
import com.codehusky.huskyguard.event.entity.DestroyEntityEvent;
import com.codehusky.huskyguard.event.entity.SpawnEntityEvent;
import com.codehusky.huskyguard.event.entity.UseEntityEvent;
import com.codehusky.huskyguard.event.inventory.UseItemEvent;
import com.codehusky.huskyguard.listener.debounce.BlockPistonExtendKey;
import com.codehusky.huskyguard.listener.debounce.BlockPistonRetractKey;
import com.codehusky.huskyguard.listener.debounce.EventDebounce;
import com.codehusky.huskyguard.listener.debounce.legacy.AbstractEventDebounce.Entry;
import com.codehusky.huskyguard.listener.debounce.legacy.BlockEntityEventDebounce;
import com.codehusky.huskyguard.listener.debounce.legacy.EntityEntityEventDebounce;
import com.codehusky.huskyguard.listener.debounce.legacy.InventoryMoveItemEventDebounce;
import com.codehusky.huskyguard.util.Blocks;
import com.codehusky.huskyguard.util.Entities;
...
import static com.codehusky.huskyguard.cause.Cause.create;
...
public class EventAbstractionListener extends AbstractListener {
     ...
     */
    public EventAbstractionListener(HuskyGuardPlugin plugin) {
        super(plugin);
    }
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case RIGHT_CLICK_AIR:
                ...
                // throw events
                if (item != null && ((SpongeWorldConfiguration) getWorldConfig(BukkitAdapter.adapt(player.getWorld()))).blockUseAtFeet.test(item)) {
    ...
    private static boolean hasInteractBypass(Block block) {
        return ((SpongeWorldConfiguration) getWorldConfig(BukkitAdapter.adapt(block.getWorld()))).allowAllInteract.test(block);
    }

    private static boolean hasInteractBypass(World world, Material material) {
        return ((SpongeWorldConfiguration) getWorldConfig(BukkitAdapter.adapt(world))).allowAllInteract.test(material);
    }

    private static boolean hasInteractBypass(World world, ItemStack item) {
        return ((SpongeWorldConfiguration) getWorldConfig(BukkitAdapter.adapt(world))).allowAllInteract.test(item);
    }
