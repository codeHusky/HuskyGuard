 ...
 * @author sk89q
 */
public class HuskyGuardBlockListener implements Listener {
     ...
     */
    public HuskyGuardBlockListener(HuskyGuardPlugin plugin) {
        this.plugin = plugin;
    }
     ...
     * @return The {@link SpongeWorldConfiguration} for the player's world
     */
    ...
    public void onBlockBurn(BlockBurnEvent event) {
        ConfigurationManager cfg = WorldGuard.getInstance().getPlatform().getGlobalStateManager();
        SpongeWorldConfiguration wcfg = (SpongeWorldConfiguration) getWorldConfig(event.getBlock().getWorld());
