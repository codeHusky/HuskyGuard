 ...
 */
public class HuskyGuardPlayerListener implements Listener {

    private static final Logger log = Logger.getLogger(HuskyGuardPlayerListener.class.getCanonicalName());
     ...
     * @param plugin
     */
    public HuskyGuardPlayerListener(HuskyGuardPlugin plugin) {
        this.plugin = plugin;
    }
