...
public class InvincibilityListener extends AbstractListener {
     ...
     */
    public InvincibilityListener(HuskyGuardPlugin plugin) {
        super(plugin);
    }
    ...
    public void onEntityDamage(EntityDamageEvent event) {
        ...
        if (victim instanceof Player) {
            ...
            SpongeWorldConfiguration worldConfig =
                    (SpongeWorldConfiguration) WorldGuard.getInstance().getPlatform().getGlobalStateManager().get((World) localPlayer.getExtent());
