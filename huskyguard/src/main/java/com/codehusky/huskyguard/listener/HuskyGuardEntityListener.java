 ...
 * @author sk89q
 */
public class HuskyGuardEntityListener implements Listener {
     ...
     */
    public HuskyGuardEntityListener(HuskyGuardPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void onEntityExplode(EntityExplodeEvent event) {
        ...
        SpongeWorldConfiguration wcfg = (SpongeWorldConfiguration) cfg.get(BukkitAdapter.adapt(world));
    ...
    public void onEntityRegainHealth(EntityRegainHealthEvent event) {
        ...
        if (wcfg.useRegions && ent instanceof Player
                && !WorldGuard.getInstance().getPlatform().getRegionContainer().createQuery().testState(
                        ...
                        HuskyGuardPlugin.inst().wrapPlayer((Player) ent),
                        Flags.HEALTH_REGEN)) {
            event.setCancelled(true);
        }
    }
    ...
    public void onFoodChange(FoodLevelChangeEvent event) {
        ...
        LocalPlayer player = HuskyGuardPlugin.inst().wrapPlayer((Player) ent);
